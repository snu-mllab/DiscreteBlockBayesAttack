...
class MyGPModel(BaseModel):
    def __init__(self, kernel_name : str, niter : int = 20):
        self.model = None 
    ...
    def fit_partial(self, hb, opt_indices, init_ind, prev_indices):
        ...
        del self.model
        self.model = fit_model_partial(hb, self.kernel_name, opt_indices, init_ind, prev_indices, params=params, niter=self.niter)
