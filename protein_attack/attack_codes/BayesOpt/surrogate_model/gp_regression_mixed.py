...
from attack_codes.BayesOpt.kernel_function.new_categorical_kernel import CategoricalKernel2, NewCategoricalKernel2
...
class NewMixedSingleTaskGP(SingleTaskGP):
    ...
    def __init__(
        ...
        self.use_horseshoe = use_horseshoe
        ...
        if self.use_horseshoe:
            #print("using horseshoe prior")
            lengthscale_prior = HorseshoePrior(scale=5)
            covar_module = ScaleKernel(
                NewCategoricalKernel2(
                    batch_shape=aug_batch_shape,
            ...
            #print("using inverse gamma prior")
